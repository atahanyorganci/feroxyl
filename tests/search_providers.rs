...
#[tokio::test]
#[ignore = "requires network access; run with: cargo test --test search_providers -- --ignored"]
async fn duckduckgo_news_search_returns_results() {
    let params = default_params("rust programming");

    let results = run_provider::<DuckDuckGoNews>(&params)
        .await
        .expect("DuckDuckGo News search should succeed");
...
#[tokio::test]
#[ignore = "requires network access; run with: cargo test --test search_providers -- --ignored"]
async fn yahoo_search_returns_results() {
    let params = default_params("rust programming");
...
#[tokio::test]
#[ignore = "requires network access; run with: cargo test --test search_providers -- --ignored"]
async fn yandex_search_returns_results() {
    let params = default_params("rust programming");

    let results = run_provider::<Yandex>(&params)
        .await
        .expect("Yandex search should succeed");
...
#[tokio::test]
#[ignore = "requires network access; run with: cargo test --test search_providers -- --ignored"]
async fn unsplash_search_returns_results() {
    let params = default_params("rust logo");

    let results = run_image_provider::<Unsplash>(&params)
        .await
        .expect("Unsplash search should succeed");
